...
class TestListAPI:
    ...
    def test_list_castmember(
        ...
        response: Any = api_client.get("/api/cast_members/")
...
class TestCreateAPI:
    ...
    def test_create_castmember_actor(
        ...
        response: Any = api_client.post("/api/cast_members/", data=data)
    ...
    def test_create_castmember_with_invalid_type(self, api_client: APIClient) -> None:
...
class TestDeleteAPI:
    ...
    def test_delete_castmember(
        ...
        response: Any = api_client.delete(f"/api/cast_members/{pedro_castmember.id}/")

        assert response.status_code == HTTP_204_NO_CONTENT
        assert response.data is None
        assert castmember_repository.get_by_id(pedro_castmember.id) is None

    def test_delete_castmember_not_found(self, api_client: APIClient) -> None:
        response: Any = api_client.delete(f"/api/cast_members/{uuid4()}/")

        assert response.status_code == HTTP_404_NOT_FOUND
        assert response.data is None

    def test_delete_castmember_with_invalid_uuid(self, api_client: APIClient) -> None:
        response: Any = api_client.delete("/api/cast_members/invalid_uuid/")
...
class TestUpdateAPI:
    ...
    def test_when_request_data_is_valid_then_update_castmember(
        ...
        response = api_client.put(f"/api/cast_members/{pedro_castmember.id}/", data=data)
    ...
    def test_when_castmember_does_not_exist_then_return_404(
        self, api_client: APIClient
    ) -> None:
        data = {
            "name": "John Travolta",
        ...
        response = api_client.put(f"/api/cast_members/{uuid4()}/", data=data)
